...
// Boosta Test Task Customs

/**
 * Creates custom post type "product"
 * @return void
 */
function boosta_custom_post_product() : void
{
	$labels = array(
		'name'               => __('Products'),
	...
	$args = array(
		'labels'        => $labels,
		'description'   => 'Product and its data',
		'public'        => true,
		'menu_position' => 4,
...
add_action('init', 'boosta_custom_post_product', 0);

/**
 * Creates custom product "subject" taxonomy 
 * @return void
 */
function boosta_custom_product_subject_taxonomy() : void
{
  $labels = array(
    'name'              => __('Subjects'),
  ...
  register_taxonomy('product_subject', 'product', $args);
}
add_action('init', 'boosta_custom_product_subject_taxonomy', 10);

/**
 * Creates custom product "color" taxonomy 
 * @return void
 */
function boosta_custom_product_color_taxonomy() : void
{
	$labels = array(
		'name'              => __('Colors'),
...
add_action('init', 'boosta_custom_product_color_taxonomy', 20);

/**
 * Creates custom product "material" taxonomy 
 * @return void
 */
function boosta_custom_product_material_taxonomy() : void
{
	$labels = array(
		'name'              => __('Materials'),
	...
	register_taxonomy('product_material', 'product', $args);
}
add_action('init', 'boosta_custom_product_material_taxonomy', 30);

/**
* Creates custom product "size" taxonomy 
* @return void
*/
function boosta_custom_product_size_taxonomy() : void
{
	$labels = array(
		'name'              => __('Sizes'),
...
add_action('init', 'boosta_custom_product_size_taxonomy', 40);